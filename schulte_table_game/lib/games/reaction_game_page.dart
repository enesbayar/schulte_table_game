...
class ReactionGamePage extends StatefulWidget {
  @override
  _ReactionPageStatePage createState() => _ReactionPageStatePage();
}

class _ReactionPageStatePage extends State<ReactionGamePage> {
  List<Cell> cellList;
  int nextTo;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(GameModel.reactionGame),
      ),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(GameModel.bestScore + GameModel.reactionBestScore.toString(),style: TextStyle(fontSize: 18),),
              ],
            ),
          ),
          Expanded(
  ...
  Container buildDefaultCell(int index) {
    return nextTo == cellList[index].value ?Container(
  ...
  void buildBestScore() {
    setState(() {
      if (GameModel.reactionBestScore == Duration.zero ||
          GameModel.reactionBestScore > stopwatch.elapsed) {
        GameModel.reactionBestScore = stopwatch.elapsed;
      }
    });
  }
