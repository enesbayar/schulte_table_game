...
class ReverseClassicGamePage extends StatefulWidget {
  @override
  _ReverseGamePageStatePage createState() => _ReverseGamePageStatePage();
}

class _ReverseGamePageStatePage extends State<ReverseClassicGamePage> {
  List<Cell> cellList;
  int nextTo;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(GameModel.reverseClassicGame),
      ),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(GameModel.bestScore + GameModel.reverseClassicOriginalBestScore.toString(),style: TextStyle(fontSize: 18),),
              ],
            ),
          ),
          Expanded(
  ...
  void buildBestScore() {
    setState(() {
      if (GameModel.reverseClassicOriginalBestScore == Duration.zero ||
          GameModel.reverseClassicOriginalBestScore > stopwatch.elapsed) {
        GameModel.reverseClassicOriginalBestScore = stopwatch.elapsed;
      }
    });
  }
