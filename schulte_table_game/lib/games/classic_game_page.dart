...
class _GamePageStatePage extends State<ClassicGamePage> {
  List<Cell> cellList;
  int nextTo;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(GameModel.classicGame),
      ),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(GameModel.bestScore + GameModel.classicOriginalBestScore.toString(),style: TextStyle(fontSize: 18),),
              ],
            ),
          ),
          Expanded(
  ...
  void buildBestScore() {
    setState(() {
      if (GameModel.classicOriginalBestScore == Duration.zero ||
          GameModel.classicOriginalBestScore > stopwatch.elapsed) {
        GameModel.classicOriginalBestScore = stopwatch.elapsed;
      }
    });
  }
