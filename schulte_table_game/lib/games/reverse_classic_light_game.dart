...
class ReverseClassicLightGamePage extends StatefulWidget {
  @override
  _ReverseGamePageStatePage createState() => _ReverseGamePageStatePage();
}

class _ReverseGamePageStatePage extends State<ReverseClassicLightGamePage> {
  List<Cell> cellList;
  int nextTo;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(GameModel.reverseClassicLightGame),
      ),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(GameModel.bestScore + GameModel.reverseClassicLightBestScore.toString(),style: TextStyle(fontSize: 18),),
              ],
            ),
          ),
          Expanded(
  ...
  void buildBestScore() {
    setState(() {
      if (GameModel.reverseClassicLightBestScore == Duration.zero ||
          GameModel.reverseClassicLightBestScore > stopwatch.elapsed) {
        GameModel.reverseClassicLightBestScore = stopwatch.elapsed;
      }
    });
  }
